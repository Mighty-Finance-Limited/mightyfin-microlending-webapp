                        ...
                        <div class="modal-content p-4">
                            ...
                            <div id="smartwizard" class="form-wizard order-create">
                                <form id="step-form-horizontal" class="step-form-horizontal h-full" action="{{ route("proxy-apply-loan") }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <h4>Guarantors</h4>
                                    <section style="min-height:200vh" id="guarantorLoanRef">
                                        <div class="row">
                                            <div class="col-lg-6 mb-2">
                                                <div class="mb-3">
                                    ...
                                    <h4>Documents</h4>
                                    <section id="wizard_Payment" class="tab-pane" role="tabpanel">
                                        <div class="row">
                                            <div class="col-lg-6 mb-2">
                                                <div class="mb-3">
    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            $('#finish').click(function(){
                ...
                const form = document.getElementById('step-form-horizontal');
                // Submit the form
                form.submit();
            });
