    ...
    <section class="flex flex-col justify-center antialiased bg-gray-200 text-gray-600 p-4">
        <div class="">
            ...
            <div class="max-w-[360px] mx-auto">
                <div class="bg-white rounded-lg mt-9">
                    <!-- Card header -->
                    <header class="text-center px-5 pb-5">
                        <!-- Avatar -->
                        <img width="20" class="inline-flex -mt-9 w-[72px] h-[72px] fill-current rounded-full border-4 border-white box-content mb-3" src="{{ asset('mfs/images/j.png') }}">
                        <!-- Card name -->
                    ...
                    <div class="bg-gray-100 text-center px-5 py-6">
                        <div class="text-sm mb-6"><strong class="font-semibold">K5900.30</strong></div>
