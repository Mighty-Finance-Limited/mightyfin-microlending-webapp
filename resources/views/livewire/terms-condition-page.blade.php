<div style="padding: 5%; background-color:#fff">
    <h1 style="color:#ffb623"><b>
        <img src="{{asset('icons/mfs/terms.png')}}" alt="">
    ...
    <br>
    <h3><b>Definitions and Interpretation</b></h3>
    ...
    <br>
    <h3><b>LenderRepresentations and Warranties</b></h3>
    ...
    (d) you hold a bank account in Zambia in your own name and will use this account to transfer money to your Holding Account and any repayment to you will be repaid to this account, except were notified to us in accordance with clause 14.5;
    ...
    <br>
    <h3><b>Acknowledgement, Payment of Principle Amount and Interest</b></h3>
    7.1 The peer-to-peer service is currently being undertaken under a regulated test trial format (sandbox). It is being regulated by SEC and the testing stage is set to run for an initial duration of 12 months’ subject to an extension for a further 12 months’ period. In addition to the regulation by SEC, the peer-to-peer lending service is subject to guidelines contained in the SEC Regulatory Sandbox Guidelines for Capital Markets. By signing this Agreement, you acknowledge that you have understood the contents of clause 7.1 and have read the SEC Regulatory Sandbox Guidelines for Capital Markets.

    7.2 You acknowledge and confirm that you have carefully considered the risks involved in lending your money through our Platform and that your participation in any Loan Agreement is entirely at your own risk.

    7.3 You acknowledge that by making a Lending Commitment and being Matched to Loan Agreements you are engaging in peer-to-peer lending and that at no time do you, as Lender, lend money to the Company.

    7.4 You acknowledge and confirm that you have made your own independent decision to make Lending Commitments and to be Matched to Loan Agreements and that your decision is based on such information as you deem appropriate under the circumstances and is without reliance upon the Company.

    7.5 You confirm that the Company has not offered you any investment advice, nor have you received any investment advice from it, relating to the suitability of any of the Products, and your participation in any Loan Agreement through the Platform is done so entirely at your own risk. If you are in any doubt, we strongly recommend that you seek independent advice from an authorized and approved financial advisor.

    7.6 In the event that the Borrower with whom you have been Matched defaults on repayments or on payments of interest the Company confirms that this default shall not impact on you, that is, you will still be entitled to and receive the principal amount and interest payments.  You will be entitled to the payment of the principal amount and interest that would have accrued as at the time of the Default Event. Payment of the principal amount and interest accrued shall be made within a period of 30 days from notification.

    <br>
    <h3><b>Platform Access and Use</b></h3>
    ...
    Premature Withdrawal of Investment/Capital
    1    The Lender shall select the investment tenure for which they desire their investment/capital to be held by the Company on the peer-to-peer lending platform at the registration stage.
    ...
    11.3     In reference to Clause 11.2 above, the Lender is encouraged to be very certain of the investment tenure that they select for their investment knowing that they will not be able to withdraw their investment before the expiration if this selected tenure.

    <br>
    <h3><b>Early Access Service</b></h3>
    12.1 We offer an Early Access service for all Lending Commitments other than those which relate to a Thirty Day Product.

    12.2. The Early Access service allows a Lender to gain immediate access to their money by requesting that the Company transfer their interest in a Loan Agreement to another Lender through the Auto-Matching System.

    12.3. The Company will charge you an administration fee (which shall include an interest rate adjustment) for using the Early Access service. The charge and calculation methodology shall change from time to time, however the administration fee shall be fully disclosed to you at the time a request for Early Access is made.

    12.4. If your Early Access request is processed, the money to which the Early Access request relates shall be returned to your Holding Account together with any accrued interest less the administration fee.

    Payment in respect of the Early Access shall be made within 30 days from the date when the request for Early Access will have been made.
    ...
    <br>
    <h3><b>Term and Termination</b></h3>
    ...
    <br>
    <h3><b>Lender Identification</b></h3>
    ...
    15.2. You agree that that we may pass your personal information to our Service Providers or any other recognized third-party company solely for the purposes of verifying your identity, performing anti-money laundering checks and fraud prevention.
    ...
    17.3. The Company shall have no liability in relation to any tax liabilities incurred by you.
    ...
    <br>
    <h3><b>Protecting Company Information</b></h3>
    ...
    22.2. Nothing in this clause shall restrict or limit either party’s general obligation at law to mitigate a loss which it may suffer or incur as a result of a matter that may give rise to a claim under this clause 22.
    ...
    23.1 Without limitation, neither the Company nor any directors, officers, employees, advisors, agents or Service Providers of the Company accept any liability whatsoever for any losses arising from the following circumstances:

    (a) a Default Event (subject to clause 7.6 above);
    ...
    23.2. Nothing in these Terms shall limit or exclude the Company’s liability for fraud, negligence, death or personal injury.

    <br>
    <h3><b>Force Majeure Event</b></h3>
    ...
    26.6. You understand that the Company will endeavor to be open on all Business Days. However, its offices and telephone lines will be closed on weekends and over Zambian public holidays. You further acknowledge that the Company will make reasonable efforts to ensure that the Platform is available continuously however that there may be instances where access to the Platform is restricted as a result of scheduled maintenance, technology failure or network failure.
    ...
    26.8. The Platform displays all statements relating to your account, which are available on demand. Should you require paper copies of statements to be sent to you, we will provide.
    ...
    26.10. The Company shall send all electronic communications to you by way of secure message within the Platform. You agree that any notifications sent using this facility within the Platform shall be deemed an acceptable form of written notification.
    ...
    27.4. If, having received our response, you are still dissatisfied, you can escalate your complaint to our Chief Executive Officer who will investigate the complaint personally and provide a final response to you within 10 Business Days.
