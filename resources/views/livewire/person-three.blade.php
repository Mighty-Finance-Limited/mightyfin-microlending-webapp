            ...
            <div class="col-md-12 ">
                <div class="page-breadcrumb">
                    <ol class="breadcrumb"> <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Borrow." href="{{ route('welcome') }}" class="home"><span property="name">Home</span></a>
                        ...
                        <li>/</li><span property="itemListElement" typeof="ListItem"><span property="name">Lemmy Amatende</span>
                ...
                <div class="bg-white pinside30">
                    <div class="row">
                        <div class="col-md-8 col-sm-7 col-xs-12">
                            <h1 class="page-title">Lemmy Amatende</h1>
                        </div>
                                    ...
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div class="wpb_text_column wpb_content_element ">
                                                <div class="wpb_wrapper">
                                                    <h2>About Lemmy Amatende <small class="designation"> CFO<br>
                                                        </small></h2>
